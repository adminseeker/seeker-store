package com.adminseeker.inventoryservice.logging;
...
public class LoggerComponent {
    ...
    @Pointcut("within(com.adminseeker.inventoryservice.controllers..*) && args(@org.springframework.web.bind.annotation.RequestHeader headers,@org.springframework.web.bind.annotation.RequestBody body,..)")
    private void controllerWithBody(Object headers, Object body) {}

    @Pointcut("within(com.adminseeker.inventoryservice.controllers..*) && args(@org.springframework.web.bind.annotation.RequestHeader headers)")
    private void controllerWithOnlyHeaders(Object headers) {}

    @Pointcut("within(com.adminseeker.inventoryservice..*)")
